 ...
 * @author nik
 */
public class FutBarred_BACorrector extends MacroStrategy {

  public FutBarred_BACorrector() {
    mStartupTime = System.currentTimeMillis();
  }

  public FutBarred_BACorrector(BarSeries.FeedType feedtype) {
    mStartupTime = System.currentTimeMillis();
...
//  strategy parameters
  ...
  private double strategy_direction = 1;
...
//        vSAR,vSAR_1,prob10lo,prob40lo);
        ...
        if (vSAR>prevBar.getHigh() && vSAR_1>barTS.getReverseIndex(2).getHigh()
          ...
          trade_direction = -1.0*strategy_direction;
  ...
  static public void main(String[] args) {
    ...
    final FutBarred_BACorrector runner = new FutBarred_BACorrector(BarSeries.FeedType.RealTime);
