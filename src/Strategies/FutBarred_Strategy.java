 ...
 * @author nik
 */
public class FutBarred_Strategy extends MacroStrategy {

  public FutBarred_Strategy() {
    mStartupTime = System.currentTimeMillis();
  }

  public FutBarred_Strategy(BarSeries.FeedType feedtype) {
    mStartupTime = System.currentTimeMillis();
...
//    setTradingTime( TimeUtils.String2Time(6,"090500"),TimeUtils.String2Time(6,"224500"));
    ...
    System.out.println("FUT_BARRED: Init strategy indicators");
...
//  strategy parameters
  ...
  public synchronized void onUpdate() {
    ...
    System.out.println("strat: this: " + this);
...
//    System.out.println("Name " + TimeUtils.Time2String(1, currData.getLastUpdateTime()) + " " + finsec.getName());
    ...
    // TRIGGER
      ...
      hlog.printRecord(1,1, prevBar.getTime(),prevBar.getOpen(), prevBar.getHigh(),prevBar.getLow(),prevBar.getClose(),
...
//        vSAR,vSAR_1,prob10lo,prob40lo);
        ...
        if(pm.getCurrentPosition().getQuantity()>0 && vSAR06 > prevBar.getLow()) {
          //exit Long
          exit_trend=true;
          direction = -1;
          target = 0;
        } else
        if(pm.getCurrentPosition().getQuantity()<0 && vSAR06 < prevBar.getHigh()) {
          //exit Short
          exit_trend=true;
          direction = 1;
          target = 0;
        ...
        System.out.println("MA_Strategy.onUpdate: TRADE: #cntr: " + finsec.getContractID() + " dir: " + direction +
        ...
        System.out.println("MA_Strategy.onUpdate: TRADE: lmptPrice: " + lmtPrice);
        // normal trade
  ...
  static public void main(String[] args) {
    ...
    final FutBarred_Strategy runner = new FutBarred_Strategy(BarSeries.FeedType.RealTime);
