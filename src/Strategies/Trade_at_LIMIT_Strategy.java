 ...
 * @author nik
 */
public class Trade_at_LIMIT_Strategy extends MacroStrategy {

  int mDirection=1;
  int mIncrement = 1;

  public Trade_at_LIMIT_Strategy() {
    mStartupTime = System.currentTimeMillis();
  }

  public Trade_at_LIMIT_Strategy(int dir) {
    mStartupTime = System.currentTimeMillis();
    mDirection = (int)Math.signum(dir);
  }

  public Trade_at_LIMIT_Strategy(BarSeries.FeedType feedtype) {
    mStartupTime = System.currentTimeMillis();
...
//  BA_Simple_Follower ba_estim = new BA_Simple_Follower(10);
  BA_Follower ba_estim = new BA_Follower(50);
...
//      int ArbPos = Arbitrage.getTotalPosition("EURUSD");
      ...
      if(curr_quantity==mLimit*mDirection && ArbPos*mDirection<200) {
        System.out.println("Increment Quantity: " + om.getCurrentPosition().getQuantity() +
                " + " + mLimit*mDirection + " ArbPos: " + ArbPos);
        mLimit=Math.abs(om.getCurrentPosition().getQuantity())+200;
      }
...
//    } // trigger
  ...
  static public void main(String[] args) {
    ...
    final Trade_at_LIMIT_Strategy runner = new Trade_at_LIMIT_Strategy(BarSeries.FeedType.RealTime);
